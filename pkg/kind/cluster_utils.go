...
/* Methoed to build an image from a specified Dockerfile */
...
/* Method to generate TLS certifications and cluster configs */
func GenCerts () {
    // Status print
...
/* Method to apply a configuration YAML file to a cluster using kubectl */
